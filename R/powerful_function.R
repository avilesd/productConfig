...
#'
#' @param FUN Name of the function within the package you want to use. Input
#'   without "".
#'
...
#'
#' @param weight orders each attribute a weight <= 1 for the value functions to
...
#'
#' @return The same value that returns the function you entered in \code{FUN}
